...
public class EnviaEmail {
    ...
    public EnviaEmail(String userName, String senha, String listaDestinatarios, String nomeRemetente, String assuntoEmail, String textoEmail) {
    ...
    public void enviarEmailAnexo(boolean envioHtml) throws Exception{
        ...
        multipart.addBodyPart(corpoEmail); // adicionando o corpo do email
        ...
        for (FileInputStream fileInputStream : arquivos) {
            ...
            multipart.addBodyPart(anexoEmail);  // adicionando o anexo do email
